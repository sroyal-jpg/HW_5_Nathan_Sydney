...
```{r}
knitr::include_graphics(here::here("program", "program_schematic2.png"))
```
...
source(here("R/electricity_cost.R"))
...
```{r}
# collection
source(here("R/collection_scrap.R"))
...
```{r}
# recycling
source(here("R/scrap_recycling.R"))
...
test_file(here("tests/test_scrap_recycling.R"))
...
test_file(here("tests/test_waste_loss.R"))
...
```{r}
# metal switching
source(here("R/metal_switching.R"))
```
...
test_file(here("tests/test_metal_switching.R"))
